...
import { Text, StyleSheet, View,ScrollView,Image,Platform, Button, TouchableOpacity } from 'react-native'
        ...
        return (
            <View style ={styles.container}>
                ...
                <View style ={styles.view17}>
                    <TouchableOpacity style ={styles.view18} onPress={()=>{this.props.navigation.navigate('SearchScreen')}}>
