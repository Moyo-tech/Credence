...
import {dummyData} from '../global';

const SCREEN_WIDTH = Dimensions.get('window').width;
const initialLayout = SCREEN_WIDTH;

const ShareResScreen = ({navigation, route}) => {
  ...
  return (
    <View style={styles.container}>
        ...
        <View>
          ...
          <View style={styles.view2}>
            <View style={styles.view3}>
              <Text style={styles.text2}>Jewellery and Bling</Text>
              <View style={styles.view4}>
                ...
                <Icon
                  ...
                  size={15}
                />
                <Text style={styles.text6}>Kigali</Text>
              </View>
            </View>
      ...
      <TouchableOpacity onPress ={()=>navigation.navigate('GenerateQRCode')}>
        <View style={styles.view11}>
          <View style={styles.view12}>
            <Text style={styles.text13}>Create QR Code</Text>
            <View style={styles.view13}>
              <Text style={styles.text13}>share</Text>
            </View>
          </View>
        </View>
      </TouchableOpacity>
