    ...
    const paymentUI = () => {
        ...
        if(!makePayment){
            ...
            return <View style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', height: 300, marginTop: 50}}>
                    ...
                    <TouchableOpacity style={{ height: 40, width: 200, marginTop: 20, backgroundColor: '#004aad', borderRadius: 20, justifyContent: 'center', alignItems: 'center'
                        }}
                        onPress={() => {
                            setMakePayment(true)
                        }}
