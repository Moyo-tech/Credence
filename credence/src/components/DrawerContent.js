             ...
             <View style ={styles.container}>
                ...
                <View style = {{flexDirection:'row', alignItems:'center',
                    ...
                    <Avatar.Image
                        ...
                        size = {80}
                        source = {{uri:"https://cdn-icons-png.flaticon.com/128/3177/3177440.png"}}
                    />

                    <View style ={{marginLeft:10}}>
                        <Text style ={{fontWeight:'bold',color:colors.cardbackground,fontSize:18 }} >John Doe</Text>
                        <Text style ={{color:colors.cardbackground,fontSize:14}} > johndoe@gmail.com</Text>
                    </View>
